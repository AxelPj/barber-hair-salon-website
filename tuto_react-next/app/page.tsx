...
export default function App() {
  ...
  else if (ongletActif === "team")
    titrePrincipal = "La Team";
  else if (ongletActif === "contact")
    titrePrincipal = "Nous contacter";
  return (
    <div className="bg-zinc-950 min-h-screen text-white">
        <header key={ongletActif} className={`animate-fade-in relative w-full bg-zinc-950 overflow-hidden flex flex-col justify-between ${ongletActif === "accueil" ? "min-h-screen h-screen" : "min-h-[60vh] h-[60vh]"}`}>
          {ongletActif === "accueil" ? (
        ...
        <div className={'relative z-10 flex flex-col justify-center items-center grow px-4 select-none mb-20 md:mb-40 ${ongletActif !== "accueil" ? "justify-end items-end" : ""}'}>
